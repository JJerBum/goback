...
func init() {
	...
	_ = userFields
	// userDescEamil is the schema descriptor for eamil field.
	userDescEamil := userFields[0].Descriptor()
	// user.EamilValidator is a validator for the "eamil" field. It is called by the builders before save.
	user.EamilValidator = userDescEamil.Validators[0].(func(string) error)
