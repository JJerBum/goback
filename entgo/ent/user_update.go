...
func (uu *UserUpdate) SetEamil(s string) *UserUpdate {
	uu.mutation.SetEamil(s)
	return uu
}

// SetNillableEamil sets the "eamil" field if the given value is not nil.
func (uu *UserUpdate) SetNillableEamil(s *string) *UserUpdate {
	if s != nil {
		uu.SetEamil(*s)
	}
	return uu
...
func (uu *UserUpdate) check() error {
	if v, ok := uu.mutation.Eamil(); ok {
		if err := user.EamilValidator(v); err != nil {
			return &ValidationError{Name: "eamil", err: fmt.Errorf(`ent: validator failed for field "User.eamil": %w`, err)}
		}
	}
	return nil
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.Eamil(); ok {
		_spec.SetField(user.FieldEamil, field.TypeString, value)
	}
...
// SetEamil sets the "eamil" field.
func (uuo *UserUpdateOne) SetEamil(s string) *UserUpdateOne {
	uuo.mutation.SetEamil(s)
	return uuo
}

// SetNillableEamil sets the "eamil" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableEamil(s *string) *UserUpdateOne {
	if s != nil {
		uuo.SetEamil(*s)
	}
	return uuo
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.Eamil(); ok {
		_spec.SetField(user.FieldEamil, field.TypeString, value)
	}
