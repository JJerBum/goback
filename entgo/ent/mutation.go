...
func (m *UserMutation) SetEamil(s string) {
	m.eamil = &s
}

// Eamil returns the value of the "eamil" field in the mutation.
func (m *UserMutation) Eamil() (r string, exists bool) {
	v := m.eamil
	if v == nil {
		return
	}
...
// OldEamil returns the old "eamil" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldEamil(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) ResetEamil() {
	m.eamil = nil
}
...
func (m *UserMutation) Fields() []string {
	fields := make([]string, 0, 2)
	if m.eamil != nil {
		fields = append(fields, user.FieldEamil)
	}
	if m.name != nil {
